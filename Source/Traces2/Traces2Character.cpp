...
ATraces2Character::ATraces2Character()
{
...
void ATraces2Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ATraces2Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATraces2Character::Move);
...
void ATraces2Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATraces2Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
